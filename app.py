...
def create_app(test_config=None):
    ...
    def change_name(id_cat):
        body = request.get_json()
        category = Category.query.get(id_cat)
        try:
    ...
    ####################################################
    #REchercher une categorie par son libelle
    ####################################################
    ...
    def search_category(word):
        mot = '%'+word+'%'
        libelle_categorie= Category.query.filter(Category.libelle_categorie.like(mot)).all()
        libelle_categorie = paginate(libelle_categorie)
        return jsonify({
